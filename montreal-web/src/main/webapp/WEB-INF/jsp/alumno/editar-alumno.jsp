...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6 offset-md-3">
      <form:form method="POST" action="/alumno/editar-alumno?id=${alumnoDTO.idAlumno }" modelAttribute="alumnoDTO">
<!--         <input name="_method" type="hidden" value="patch" /> -->
        ...
        <div class="form-group">
          ...
          <form:input path="apellidos"  maxlength="40" minlength="3" type="text" class="form-control" required="required"/>
        </div>        
