      ...
      <tbody>
        <c:forEach var="programa" items="${programasDTO}">
          <tr>
            ...
            <td>
              <%--             	<a href="/eliminar-programa?id=${programa.idPrograma}" class="btn btn-danger btn-sm">Eliminar</a>  --%>
              <!--             	<a href="/programas_estudio/1/edit" class="btn btn-warning btn-sm">Editar</a> --> 
              <a href="/alumno/detalle-programa-postulable-alumno?id=${programa.idPrograma }" class="btn btn-info btn-sm ">Ver Detalles</a>
            </td>
          </tr>
        </c:forEach>
      </tbody>
