  ...
  <div class="col-md-6 offset-md-3">
    <form method="POST" action="/">
      ...
      <c:if test="${ perfil.equals(\"CEL\") }">
         <a href="/cel/postular-programa?id=${programaDTO.idPrograma }" class="btn btn-primary btn-md btn-block">Impartir Programa</a>
      </c:if>
      
      <c:if test="${ perfil.equals(\"ALUMNO\") }">
        <a href="/alumno/postular-programa?id=${programaDTO.idPrograma }" class="btn btn-primary btn-md btn-block">Postular</a>
      </c:if>   
    </form>
  </div>
